...
describe('InvoicesPageService', () => {
    ...
    const LOWER_BOUND: string = '2018-01-01T00:00:00.000Z'
    const UPPER_BOUND: string = '2018-01-31T00:00:00.000Z'
    const UPPER_BOUND_PLUS_ONE_DAY: string = '2018-02-01T00:00:00.000Z'
    ...
    it('should send only issueDateFrom request param when dates range is lower bound', () => {
        ...
        service.findInvoices(new InvoicesSearchCriteria(new Date(LOWER_BOUND)));
    });
    ...
    it('should send only issueDateTo request param when dates range is upper bound', () => {
        ...
        service.findInvoices(new InvoicesSearchCriteria(null, new Date(UPPER_BOUND)));
    });
    ...
    it('should send both issueDateFrom and issueDateTo request params when dates range is lower and upper bound', () => {
        ...
        service.findInvoices(new InvoicesSearchCriteria(new Date(LOWER_BOUND), new Date(UPPER_BOUND)));
    });
});
