...
import static com.softwarewithpassion.nrgyinvoicr.backend.plans.control.expression.buckets.NightPlanFixture.nightFlattened;
import static com.softwarewithpassion.nrgyinvoicr.backend.plans.control.expression.buckets.NightPlanFixture.nightPlan;
import static com.softwarewithpassion.nrgyinvoicr.backend.plans.control.expression.buckets.WinterPlanFixture.winterFlattened;
import static com.softwarewithpassion.nrgyinvoicr.backend.plans.control.expression.buckets.WinterPlanFixture.winterPlan;
import static com.softwarewithpassion.nrgyinvoicr.backend.plans.control.expression.buckets.WinterWeekendNightPlanFixture.winterWeekendNightFlattened;
import static com.softwarewithpassion.nrgyinvoicr.backend.plans.control.expression.buckets.WinterWeekendNightPlanFixture.winterWeekendNightPlan;
...
class BucketsTest {
    ...
    private static Stream<Arguments> parameters() {
        ...
        return Stream.of(
                of("Stable Plan", StablePlanFixture.stablePlan(), StablePlanFixture.stableFlattened(reference)),
                of("Night Plan", nightPlan(), nightFlattened(reference)),
                of("Winter Plan", winterPlan(), winterFlattened(reference)),
                of("Weekend Plan", WeekendPlanFixture.weekendPlan(), WeekendPlanFixture.weekendFlattened(reference)),
