...
import static com.hclc.nrgyinvoicr.systemtesting.stories.clients.ClientPlanAssignmentBuilder.aClientPlanAssignment;
...
public class ClientPlanAssignmentStory extends ClientStories {
    ...
    private ClientPlanAssignment assignAPlan(String planName) {
        ClientPlanAssignment clientPlanAssignment = aClientPlanAssignment()
