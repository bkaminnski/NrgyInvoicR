...
public class InvoiceGenerationStory {
    ...
    private void assertThatUserSeesInvoiceLines(Client client, PlanVersion planVersion, ReadingUpload readingUpload) {
        ...
        assertThatUserSees(InvoiceLineBuilder.anInvoiceLine().withNumber("4").withDescription("Subscription fee").withUnitPrice("2.91").withQuantity("1").withUnit("NONE").withNet("2.91").withVat("23%").withGross("3.58").build());
    }
